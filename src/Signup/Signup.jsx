                    ...
                    <div className="col-md-6  align-items-center">
                        <div className="w-75">
                            ...
                            <form className="ml-5">
                                ...
                                <button type="submit" className="btn-dark btn-block p-3 mt-3  w-50 rounded">
                                    Create Account 
                                    <i className="fa-solid fa-arrow-right ml-2" />
                                </button>
                                <div className="text-center mt-4">
                                    <p className="text-secondary d-block mb-3">Sign up with <hr/> </p>
                                    <div className="d-flex justify-content-center ml-5">
                                        <button type="button" className=" btn-outline-secondary  mx-2 px-5" style={{color:"#3b82f6"}}>
                                        <i className="fa-brands fa-facebook" style={{ color: "#3b82f6" ,fontSize:"20px", marginRight:"10px"}} />
                                            Facebook
                                        </button>
                                        <button type="button" className=" btn-outline-secondary mx-2 px-5" style={{color:"#EA4335"}}>
                                        <i className="fa-brands fa-google" style={{ color: "#EA4335" ,fontSize:"20px", marginRight:"10px"}} />
                                            Google
                                        </button>
                                        <button type="button" className=" btn-outline-secondary mx-2 px-5">
                                        <i className="fa-brands fa-microsoft" style={{ color: "rgb(241, 219, 14)" ,fontSize:"20px", marginRight:"10px"}} />
                                            Microsoft
                                        </button>
                                    </div>
                                </div>
